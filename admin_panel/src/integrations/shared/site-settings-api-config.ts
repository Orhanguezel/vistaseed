...
export const SITE_SETTINGS_API_SECTIONS: SiteSettingsApiSectionDef[] = [
  ...
  },
  {
    titleKey: "googleAds",
    fields: [
      { key: "google_ads_enabled", labelKey: "googleAdsEnabled", type: "switch" },
      { key: "google_ads_developer_token", labelKey: "googleAdsDeveloperToken", type: "password" },
      { key: "google_ads_client_id", labelKey: "googleAdsClientId", type: "password" },
      { key: "google_ads_client_secret", labelKey: "googleAdsClientSecret", type: "password" },
      { key: "google_ads_refresh_token", labelKey: "googleAdsRefreshToken", type: "password" },
      { key: "google_ads_customer_id", labelKey: "googleAdsCustomerId", placeholderKey: "googleAdsCustomerId" },
      { key: "google_ads_login_customer_id", labelKey: "googleAdsLoginCustomerId", placeholderKey: "googleAdsCustomerId" },
    ],
  },
  {
