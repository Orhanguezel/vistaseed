...
- [ ] Migration, admin tab, frontend kartlar, `shared-types` hizası (Codex; Antigravity ürün detay bilgi kartı düzeni)
  ...
  Not: `137_product_agricultural_metadata.sql` migration dosyasi mevcut. Bu turda tarimsal enum/type seti `@agro/shared-types` icine tasindi; admin product tipleri ve frontend `Product` modeli ortak metadata arayuzune baglandi. Kalan ana is frontend detay kartlarini bu alanlardan beslemek ve migration'in tum ortamlarda uygulanmasini dogrulamak.
