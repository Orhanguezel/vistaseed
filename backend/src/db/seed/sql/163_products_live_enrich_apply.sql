...
-- DROP YOK, products DELETE YOK (siparis FK'leri korunur). Sadece UPDATE + UPSERT,
-- specs/images bu 8 urun icin DELETE+INSERT (inbound FK yok). 2026-06-04.
...
-- 2) products: sadece UPDATE (8 urun)
UPDATE `products` SET `price` = '1250.00', `image_url` = '/uploads/products/avar-rootstock-01.webp', `storage_asset_id` = '14909400-0000-4000-8000-000000000001', `images` = '["/uploads/products/avar-rootstock-01.webp"]', `storage_image_ids` = '["14909400-0000-4000-8000-000000000001"]', `botanical_name` = 'Cucurbita maxima × Cucurbita moschata', `planting_seasons` = '[]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000001';
UPDATE `products` SET `price` = '850.00', `image_url` = 'https://www.vistaseeds.com.tr/uploads/uploads/products/525C9BB8-18F9-4C2B-B5BD-0BD9E296E293.png', `storage_asset_id` = '15009400-0000-4000-8000-000000000001', `images` = '["https://www.vistaseeds.com.tr/uploads/uploads/products/525C9BB8-18F9-4C2B-B5BD-0BD9E296E293.png"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000001"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000002';
UPDATE `products` SET `price` = '820.00', `image_url` = '/uploads/products/kizgin-f1-source-01.webp', `storage_asset_id` = '15009400-0000-4000-8000-000000000002', `images` = '["/uploads/products/kizgin-f1-source-01.webp"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000002"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["ilkbahar", "sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000003';
UPDATE `products` SET `price` = '840.00', `image_url` = 'https://www.vistaseeds.com.tr/uploads/uploads/products/07CF9486-7623-45AF-B851-C971E1FA5780.png', `storage_asset_id` = '15009400-0000-4000-8000-000000000003', `images` = '["https://www.vistaseeds.com.tr/uploads/uploads/products/07CF9486-7623-45AF-B851-C971E1FA5780.png"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000003"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000004';
UPDATE `products` SET `price` = '780.00', `image_url` = '/uploads/products/birlik-f1-source-01.webp', `storage_asset_id` = '15009400-0000-4000-8000-000000000004', `images` = '["/uploads/products/birlik-f1-source-01.webp"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000004"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000005';
UPDATE `products` SET `price` = '860.00', `image_url` = 'https://www.vistaseeds.com.tr/uploads/uploads/products/Ads_z_tasar_m.jpg', `storage_asset_id` = '15009400-0000-4000-8000-000000000005', `images` = '["https://www.vistaseeds.com.tr/uploads/uploads/products/Ads_z_tasar_m.jpg"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000005"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["ilkbahar", "sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000006';
UPDATE `products` SET `price` = '870.00', `image_url` = 'https://www.vistaseeds.com.tr/uploads/uploads/products/Ads_z_tasar_m.png', `storage_asset_id` = '15009400-0000-4000-8000-000000000006', `images` = '["https://www.vistaseeds.com.tr/uploads/uploads/products/Ads_z_tasar_m.png"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000006"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["ilkbahar", "sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000007';
UPDATE `products` SET `price` = '800.00', `image_url` = 'https://www.vistaseeds.com.tr/uploads/uploads/products/Untitled_design.jpg', `storage_asset_id` = '15009400-0000-4000-8000-000000000007', `images` = '["https://www.vistaseeds.com.tr/uploads/uploads/products/Untitled_design.jpg"]', `storage_image_ids` = '["15009400-0000-4000-8000-000000000007"]', `botanical_name` = 'Capsicum annuum', `planting_seasons` = '["ilkbahar", "sonbahar"]', `water_need` = 'Orta', `sun_exposure` = 'Tam güneş' WHERE `id` = 'pppppppp-0001-4000-8000-000000000008';

-- 3) product_i18n: UPSERT (tr/en gunceller, de ekler)
INSERT INTO `product_i18n` (`product_id`, `locale`, `title`, `slug`, `description`, `alt`, `tags`, `meta_title`, `meta_description`) VALUES
('pppppppp-0001-4000-8000-000000000001', 'tr', 'AVAR', 'avar', 'AVAR
