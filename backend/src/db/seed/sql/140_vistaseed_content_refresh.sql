...
(UUID(), 'contact_phone', '*', '"0242 464 19 25"'),
(UUID(), 'contact_phone_display', '*', '"0242 464 19 25"'),
(UUID(), 'contact_phone_tel', '*', '"02424641925"'),
(UUID(), 'contact_email', '*', '"info@bereketfide.com.tr"'),
(UUID(), 'contact_to_email', '*', '"info@bereketfide.com.tr"'),
...
(UUID(), 'seo_local_business', '*', '{"@context":"https://schema.org","@type":"Organization","name":"VistaSeed","description":"Antalya Aksu merkezli tohum ve fide ekosistemi.","email":"info@bereketfide.com.tr","telephone":"+90 242 464 19 25","address":{"@type":"PostalAddress","streetAddress":"Fatih Mah. Isparta Yolu 07112","addressLocality":"Aksu","addressRegion":"Antalya","addressCountry":"TR"}}'),
  ...
  "columns": [
    ...
    },
    {
      ...
      "links": [
        ...
        {"label": "info@bereketfide.com.tr", "href": "mailto:info@bereketfide.com.tr"}
      ]
    }
  ]
}')
