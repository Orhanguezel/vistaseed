...
VALUES
  ...
  (
    ...
    'About Us',
    'about-us',
    '{"html":"<p>Vista Seeds delivers seed solutions backed by field experience, research, and sustainable production principles.</p><p>We focus on quality, reliability, and long-term grower partnerships.</p>"}',
    'Corporate overview of Vista Seeds.',
    'About Us | {{SITE_NAME}}',
    'Learn more about Vista Seeds, our background, and our production approach.'
  ),
  (
    '55555555-5555-4555-8555-555555555552',
    'en',
