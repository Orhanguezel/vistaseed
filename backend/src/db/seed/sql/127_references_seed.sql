...
VALUES
  (
    ...
    'Vista Seeds anlatısının beslendiği üretim omurgasını, modern sera ve aşı odası kapasitesi üzerinden özetleyen vaka kaydı.',
    '<p>Bu kayıt, Bereket Fide''nin Antalya Aksu merkezli üretim omurgasını Vista Seeds ekosistemi içinde nasıl konumlandırdığımızı gösterir. Modern sera altyapısı, aşı odası kapasitesi ve operasyonel ölçek; ürün, bayi ve teklif yüzeylerindeki güven sinyallerinin ana kaynağıdır.</p><p>Kurumsal içerikte kullanılan kapasite bilgileri, resmi kurumsal verilerle uyumlu olacak şekilde burada referans vaka olarak tutulur.</p>',
    'Bereket Fide üretim kampüsü görseli',
    'Bereket Fide Üretim Kampüsü | Vista Seeds',
    'Bereket Fide üretim omurgasının Vista Seeds ürün ve içerik akışına nasıl bağlandığını özetleyen vaka kaydı.'
  ),
  (
    ...
    'bereket-fide-production-campus',
    'A case entry showing the production backbone behind the Vista Seeds narrative through greenhouse and grafting-room capacity.',
    '<p>This record explains how Bereket Fide''s Antalya Aksu production backbone is positioned within the Vista Seeds ecosystem. Greenhouse infrastructure, grafting-room capacity, and operational scale are the main trust signals behind product, dealer, and quotation surfaces.</p><p>Capacity figures used in the corporate narrative are kept here as a reference case aligned with official company information.</p>',
    'Bereket Fide production campus visual',
    'Bereket Fide Production Campus | Vista Seeds',
    'A case entry summarizing how Bereket Fide production operations support Vista Seeds content and product surfaces.'
  ),
  (
    ...
    'Antalya Aksu Operasyon Merkezi | Vista Seeds',
  ...
  (
    ...
    'Antalya Aksu Operations Center | Vista Seeds',
  ...
  (
    ...
    'Aşılı Fide Kapasite Programı | Vista Seeds',
  ...
  (
    ...
    'Grafted Seedling Capacity Program | Vista Seeds',
  ...
  (
    ...
    'Bayi ağı görseli',
    'Bayi Ağı ve Bölgesel Dağıtım Modeli | Vista Seeds',
  ...
  (
    ...
    'Dealer Network and Regional Distribution Model | Vista Seeds',
  ...
  (
    ...
    'Toplu Satış ve Kurumsal Tedarik Akışı | Vista Seeds',
  ...
  (
    ...
    'Bulk Sales and Corporate Supply Flow | Vista Seeds',
  ...
  (
    ...
    'Teknik İçerik ve Bilgi Bankası Yayınları | Vista Seeds',
  ...
  (
    ...
    'Technical Content and Knowledge-Base Publications | Vista Seeds',
