...
(UUID(), 'footer_keywords', '*', '["Vista Seeds","Tohum","Fide","Bayi Ağı","Toplu Satış"]'),
...
(UUID(), 'seo_defaults', '*', '{"canonicalBase":"http://localhost:3000","siteName":"{{SITE_NAME}}","description":"Vista Seeds tohum, fide, bayi ağı ve teknik içerik ekosistemi.","ogLocale":"tr_TR","author":"{{SITE_NAME}}","themeColor":"#F97316","twitterCard":"summary_large_image","robots":"index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1","googlebot":"index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1"}'),
(UUID(), 'seo_pages_home', '*', '{"title":"{{SITE_NAME}}","description":"Vista Seeds tohum, fide, bayi ağı ve teknik içerik ekosistemi.","keywords":"Vista Seeds, tohum, fide, bayi ağı, antalya","ogImage":"/uploads/media/hero/og-default.jpg","robots":"index, follow","noIndex":false}'),
(UUID(), 'seo_pages_products', '*', '{"title":"Ürünler | {{SITE_NAME}}","description":"Vista Seeds ürün kataloğunu ve tarımsal metadata detaylarını inceleyin.","keywords":"ürünler, tohum, fide, katalog","ogImage":"/uploads/media/hero/og-default.jpg","robots":"index, follow","noIndex":false}'),
(UUID(), 'seo_pages_about', '*', '{"title":"Hakkımızda | {{SITE_NAME}}","description":"Vista Seeds ekosistemi ve Bereket Fide üretim altyapısı hakkında bilgi edinin.","keywords":"hakkımızda, Vista Seeds, bereket fide","ogImage":"/uploads/media/hero/og-default.jpg","robots":"index, follow","noIndex":false}'),
(UUID(), 'seo_pages_contact', '*', '{"title":"İletişim | {{SITE_NAME}}","description":"Ürün, bayi ve toplu satış talepleri için Vista Seeds ile iletişime geçin.","keywords":"iletişim, teklif, bayi","ogImage":"/uploads/media/hero/og-default.jpg","robots":"index, follow","noIndex":false}'),
...
SET
  `title` = 'Hakkımızda',
  `content` = '{"html":"<p>Vista Seeds, Bereket Fide üretim deneyiminden beslenen dijital tarım ekosistemidir.</p><p>Ürün kataloğu, bilgi bankası ve toplu satış akışlarını tek yapıda birleştirir.</p>"}',
  `summary` = 'Vista Seeds ekosistemi hakkında kurumsal bilgi.',
...
SET
  ...
  `summary` = 'Tarımda sürdürülebilir başarı için neden Vista Seeds tercih edilmelidir?'
WHERE `page_id` = 'neden-biz-uuid-001' AND `locale` = 'tr';

UPDATE `custom_pages_i18n`
SET
  `title` = 'AR-GE ve Üretim Altyapısı',
  `content` = '{"html":"<h2>Üretim bilgisini dijital akla dönüştürüyoruz</h2><p>Vista Seeds, ürün metadata, içerik ve teklif süreçlerini saha gerçekleriyle hizalayacak şekilde kurgulanmıştır.</p><h3>Odaklarımız</h3><ul><li>Çeşit bilgisi ve teknik yapı</li><li>Ürün karşılaştırma ve karar desteği</li><li>Operasyonel içerik standardizasyonu</li></ul>"}',
  `summary` = 'Vista Seeds ürün ve içerik altyapısının arkasındaki yaklaşım.',
  `meta_title` = 'AR-GE ve Üretim Altyapısı | Vista Seeds',
  `meta_description` = 'Vista Seeds ürün, metadata ve içerik altyapısı hakkında bilgi edinin.'
...
SET
  ...
  `meta_title` = 'Ekim Rehberi | Vista Seeds',
  `meta_description` = 'Ekim öncesi hazırlık, sulama ve saha planlaması için Vista Seeds rehberi.'
...
SET
  ...
  `meta_title` = 'Sürdürülebilirlik | Vista Seeds',
  `meta_description` = 'Vista Seeds sürdürülebilirlik yaklaşımı ve operasyonel öncelikleri.'
...
SET
  ...
  `meta_title` = 'Bayi Girişi | Vista Seeds',
  `meta_description` = 'Vista Seeds bayilerine özel giriş ve işlem alanı.'
WHERE `page_id` = 'cp-uuid-bayi-001' AND `locale` = 'tr';

UPDATE `support_faqs_i18n`
SET `question` = 'Vista Seeds ne sunuyor?',
    `answer` = 'Vista Seeds; ürün kataloğu, bilgi bankası ve toplu satış süreçlerini tek yapıda toplayan dijital tarım ekosistemidir.'
...
SET
  ...
  `cover_letter` = 'Üretim planlama, saha operasyonları ve kalite sistemleri alanında deneyimliyim. Vista Seeds ekibine operasyonel disiplin ve süreç iyileştirme katkısı sunabileceğime inanıyorum.'
