...
UPDATE `site_settings` SET `value` = '"info@vistaseeds.com.tr"'  WHERE `key` = 'contact_to_email';
...
UPDATE `site_settings` SET `value` = '"info@vistaseeds.com.tr"'  WHERE `key` = 'site__contact_email';
