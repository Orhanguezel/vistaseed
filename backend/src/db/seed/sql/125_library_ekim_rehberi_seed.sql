...
VALUES
  (
    ...
    'Domates Fidesi Dikim Rehberi | vistaseeds',
  ...
  (
    ...
    'Tomato Seedling Transplant Guide | vistaseeds',
  ...
  (
    ...
    'Biber Fidesi Sera Geçiş Rehberi | vistaseeds',
  ...
  (
    ...
    'Pepper Seedling Greenhouse Transition Guide | vistaseeds',
  ...
  (
    ...
    'Salatalık Fidesi İlk Gelişim Rehberi | vistaseeds',
  ...
  (
    ...
    'Cucumber Seedling Early Growth Guide | vistaseeds',
  ...
  (
    ...
    'Karpuz Aşılı Fide Şaşırtma Rehberi | vistaseeds',
  ...
  (
    ...
    'Grafted Watermelon Seedling Transplant Guide | vistaseeds',
