...
VALUES
  (
    ...
    'Domates Fidesi Dikim Rehberi | Vista Seeds',
  ...
  (
    ...
    'Tomato Seedling Transplant Guide | Vista Seeds',
  ...
  (
    ...
    'Biber Fidesi Sera Geçiş Rehberi | Vista Seeds',
  ...
  (
    ...
    'Pepper Seedling Greenhouse Transition Guide | Vista Seeds',
  ...
  (
    ...
    'Salatalık Fidesi İlk Gelişim Rehberi | Vista Seeds',
  ...
  (
    ...
    'Cucumber Seedling Early Growth Guide | Vista Seeds',
  ...
  (
    ...
    'Karpuz Aşılı Fide Şaşırtma Rehberi | Vista Seeds',
  ...
  (
    ...
    'Grafted Watermelon Seedling Transplant Guide | Vista Seeds',
