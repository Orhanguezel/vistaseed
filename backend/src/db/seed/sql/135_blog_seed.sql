...
VALUES
  ('a1000001-0001-4001-8001-000000000001', 'tohum-bilimi', 'Vista Seeds', NULL, 'published', NOW(3), 1, 0),
  ('a1000001-0001-4001-8001-000000000002', 'ekim-teknikleri', 'Vista Seeds', NULL, 'published', NOW(3), 1, 1)
...
VALUES
  (
    ...
    'Vista Seeds blog: çimlenme ipuçları.'
  ),
  (
