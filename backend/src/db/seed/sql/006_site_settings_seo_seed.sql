...
INSERT INTO `site_settings` (`id`,`key`,`locale`,`value`) VALUES
  ...
  (UUID(), 'site_favicon',          '*', '{"url":"/uploads/media/logo/vistaseed_logo.png","alt":"{{SITE_NAME}} Favicon"}'),
  (UUID(), 'site_apple_touch_icon', '*', '{"url":"/uploads/media/logo/vistaseed_logo.png","alt":"{{SITE_NAME}} Apple Touch"}'),
  (UUID(), 'site_app_icon_512',     '*', '{"url":"/uploads/media/logo/vistaseed_logo.png","alt":"{{SITE_NAME}} Icon 512"}'),
...
INSERT INTO `site_settings` (`id`,`key`,`locale`,`value`) VALUES
  ...
  (UUID(), 'seo_app_icons', '*',
   '{"appleTouchIcon":"/uploads/media/logo/vistaseed_logo.png","favicon":"/uploads/media/logo/vistaseed_logo.png","faviconSvg":"/uploads/media/logo/vistaseed_logo.png"}'),
